...
{
    public abstract class ReceiveFilterBase : IReceiveFilter
    {
        ...
        protected ReceiveFilterBase(ReceiveFilterBase previousRequestFilter)
        {
        ...
        public void Initialize(ReceiveFilterBase previousRequestFilter)
        {
        ...
        /// <returns></returns>
        public abstract byte[] Filter(byte[] readBuffer, int offset, int length, bool toBeCopied, out int rest);
        ...
        /// </value>
        public IReceiveFilter NextReceiveFilter { get; protected set; }
