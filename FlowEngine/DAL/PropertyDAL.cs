...
namespace FlowEngine.DAL
{
    ...
    public class PropertyDAL : IDbAccess
    {
        ...
        {
            /// 该方法的代码由插件自动生成，请勿修改。
            string sql = @"INSERT INTO PROPERTY (ID,NODEID,NAME,VALUE,CONDITION,DESCRIPTION ) values (@ID,@NODEID,@NAME,@VALUE,@CONDITION,@DESCRIPTION)";
            return Helper.ExecuteNonQuery(sql, obj.ID, obj.NODEID, obj.NAME, obj.VALUE, obj.CONDITION, obj.DESCRIPTION);
        }
